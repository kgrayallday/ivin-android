...
public class BMWMaintenanceActivity extends AppCompatActivity implements Dialog.NoticeDialogListener {
...
//    ArrayList<Scan> mArrayList = new ArrayList<>(); // create array list to hold database query results?
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_bmwmaintenance);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == 0 || requestCode == CommonStatusCodes.SUCCESS && data != null) {
    ...
    public void myfunction(){
        ...
        Cursor mCursor = mDatabase.getScans("'maintenance'");
...
//                String job = mCursor.getString(mCursor.getColumnIndex(COLUMN_1_JOB));
    ...
    public void servesUp(){
        JSONArray jobj = jsonCreator("'maintenance'");
        new BMWMaintenanceActivity.JSONTask().execute(jobj); // was new JSONTask().execute(String.valueOf(jobj));
    }
...
//                }
    ...
    public class JSONTask extends AsyncTask<JSONArray, Integer, String> {
        ...
        protected void onPreExecute() {
            progressDialog = new ProgressDialog(BMWMaintenanceActivity.this);
