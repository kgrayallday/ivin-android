...
public class VWServiceActivity extends AppCompatActivity implements Dialog.NoticeDialogListener{
...
//    ArrayList<Scan> mArrayList = new ArrayList<>(); // create array list to hold database query results?
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_vwservice);
    ...
    public void myfunction(){
        ...
        Cursor mCursor = mDatabase.getScans("'service'");
        ...
        if (mCursor.moveToFirst()) {
            while (!mCursor.isAfterLast()) {
                ...
                mCursor.moveToNext();
                // Provides count for all Service Scans
    ...
    public void servesUp(){
        JSONArray jobj = jsonCreator("'service'");
        new VWServiceActivity.JSONTask().execute(jobj); // was new JSONTask().execute(String.valueOf(jobj));
    }
...
//                }
    ...
    public class JSONTask extends AsyncTask<JSONArray, Integer, String> {
        ...
        protected void onPreExecute() {
            progressDialog = new ProgressDialog(VWServiceActivity.this);
